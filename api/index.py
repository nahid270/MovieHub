...
def add_movie(tmdb_id):
    if movies_collection is not None:
        if movies_collection.find_one({"tmdb_id": tmdb_id}): flash('Movie already exists.', 'warning')
            ...
            if movie_details: movies_collection.insert_one(map_movie_from_tmdb(movie_details)); flash('Movie added successfully.', 'success')
