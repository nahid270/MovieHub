...
def manage_content():
    ...
    return render_admin_page(ADMIN_CONTENT_TEMPLATE, title="Manage Content", content=ADMIN_MOVIES_CONTENT, site_content=site_content, tmdb_results=tmdb_results)
...
def edit_content(content_id):
    ...
    try:
        ...
        return render_admin_page(ADMIN_EDIT_CONTENT_TEMPLATE, title="Edit Content", content=ADMIN_EDIT_CONTENT_TEMPLATE, item=item, all_categories=all_categories)
    except Exception as e:
...
def manage_categories():
    ...
    return render_admin_page(ADMIN_CATEGORIES_TEMPLATE, title="Manage Categories", content=ADMIN_CATEGORIES_TEMPLATE, categories=all_categories)
